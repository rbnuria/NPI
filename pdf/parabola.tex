...
\newcommand{\doctitle}{Práctica 1 }
% Subtítulo.
\newcommand{\docsubtitle}{Análisis Predictivo Empresarial Mediante Clasificación}
% Fecha.
\newcommand{\docdate}{5 \ de \ Noviembre \ de \ 2017}
% Asignatura.
\newcommand{\subject}{Inteligencia de Negocio}
% Autor.
\newcommand{\docauthor}{Antonio R. Moya Martín-Castaño}
\newcommand{\docaddress}{Universidad de Granada}
\newcommand{\docemail}{anmomar85@correo.ugr.es}
