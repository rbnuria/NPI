...
namespace KinectSimpleGesture
{
    /// <summary>
    /// Clase WaveGestureR
    /// Representa un movimiento de deslizamiento del brazo de derecha a izquierda.
    /// </summary>
    ...
    /// <summary>
    /// Clase SilenceGestureIn
    /// Representa el gesto de mandar callar.
    /// </summary>
    public class SilenceGestureIn
    {
        readonly int WINDOW_SIZE = 500;
        ...
        public SilenceGestureIn()
        {
            SilenceSegment1 silenceSegment1 = new SilenceSegment1();
            SilenceSegment2 silenceSegment2 = new SilenceSegment2();
